        ...
        >
            ...
            >
                ...
                >
                    <div
                        v-if="show"
                        class="bg-white rounded-t-2xl sm:rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] sm:max-h-[85vh] flex flex-col overflow-hidden"
                    >
                        <!-- Header - Fixed -->
                        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 flex-shrink-0">
                            <div class="flex items-start justify-between">
                                ...
                                <button
                                    @click="close"
                                    class="p-1 hover:bg-white/20 rounded-lg transition-colors flex-shrink-0"
                                >
                        ...
                        <div class="p-6 overflow-y-auto flex-1">
                            ...
                            <div v-else-if="insight" class="space-y-4">
                                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 border border-indigo-100">
                                    <p class="text-gray-700 leading-relaxed whitespace-pre-wrap break-words">{{ insight }}</p>
                                </div>
